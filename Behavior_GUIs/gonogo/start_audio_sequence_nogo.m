...
up_ms = round(1000/app.audio_stimulation_frequency_nogo.Value);
low_ms = up_ms;
...
%     case 0  % left + dac val
        fprintf(arduino,'%c',['m'  up_l up_h low_l low_h ncycles_l ncycles_h  mbank  dac_val_audio.nogo_L]);
else
%     case 1 % right  + dac val
        fprintf(arduino,'%c',['n'  up_l up_h low_l low_h ncycles_l ncycles_h  mbank  dac_val_audio.nogo_R]);
end
