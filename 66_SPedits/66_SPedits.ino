...
//uint8_t  visual_start_pending_L = 0;  
//uint8_t  visual_start_pending_R = 0;  
...
//attach the two servos
  ...
  myservoLR.attach(7);  // attaches the servo on pin 9 to the servo object
